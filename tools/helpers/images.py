...
def make_prop(args, cfg, full_props_path):
    ...
    add_prop("waydroid.xdg_runtime_dir", "container_xdg_runtime_dir")
    add_prop("waydroid.pulse_runtime_path", "container_pulse_runtime_path")
    add_prop("waydroid.wayland_display", "container_wayland_display")
